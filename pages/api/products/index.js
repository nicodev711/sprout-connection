    ...
    if (req.method === 'POST') {
        ...
        try {
            ...
            const newProduct = new Product({
                ...
                price,
                category,
                imageCDNLink: imageCDNLink || 'https://res.cloudinary.com/dyglfoum8/image/upload/v1718651966/sproutConnection/product_edpric.jpg', // Ensure this can be empty or null
                isListed: true,
                isDelivered: false,
