      ...
      <div className="bg-background text-text min-h-screen">
        <div className="hero min-h-screen bg-cover bg-center" style={{backgroundImage: "url('/hero.png')"}}>
          ...
          <div className="hero-content text-center text-neutral-content flex items-center justify-center">
            <div className="max-w-2xl px-4 py-8">
              <h1 className="mb-5 text-2xl text-white sm:text-5xl font-bold">Fresh Garden Produce from Your
                Neighbors!</h1>
              <p className="mb-5 text-lg text-white sm:text-xl">Buy and sell fresh, locally-grown produce directly from
                gardeners in your
                community.</p>
        ...
        <section className="py-16 text-center">
          ...
          <div className="flex flex-wrap justify-center mt-8 space-x-4">
            <div className="card w-64 bg-white shadow-lg">
              <figure className="px-10 pt-10">
                <img src="/images/product1.jpg" alt="Tomatoes" className="rounded-xl"/>
              </figure>
              <div className="card-body">
            ...
            <div className="card w-64 bg-white shadow-lg">
              <figure className="px-10 pt-10">
                <img src="/hero.png" alt="Carrots" className="rounded-xl"/>
              </figure>
              <div className="card-body">
